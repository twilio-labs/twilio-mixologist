...
function determineCoffeeFromMessage(messageBody) {
  ...
  for (let option of Object.keys(POSSIBLE_OPTIONS)) {
    if (message.indexOf(option) !== -1 && AVAILABLE_OPTIONS.indexOf(POSSIBLE_OPTIONS[option]) !== -1) {
...
module.exports = { AVAILABLE_OPTIONS, POSSIBLE_OPTIONS, determineCoffeeFromMessage }