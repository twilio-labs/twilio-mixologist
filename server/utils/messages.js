...
const ORDER_CREATED_MESSAGES = [
  "Thanks for ordering a ${product} from the Twilio powered Coffee Shop. Your order number is #${orderNumber}. We'll text you back when it's ready. In the mean time check out this repo ${repoUrl} if you want to see how we built this app."
];
